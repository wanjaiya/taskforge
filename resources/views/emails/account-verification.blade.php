...
@section('content')
    ...
    <p class="bigger-bold" style="font-family: Helvetica Neue, sans-serif;text-align:center;font-size: 22px;">Hello
        {{ ucwords(strtolower($name)) ?: '' }},</p>
    ...
    <p
        style="font-family: Helvetica Neue, sans-serif;font-size: 18px;line-height: 1.6;font-weight: normal;margin: 30px 0 30px;padding: 0;color:#5A6166;text-align:center;">
        In order to complete your registration and log in, please click on link and enter the below "Activation Code".</p>
    ...
    <p
        style="font-family: Helvetica Neue, sans-serif;font-size: 18px;line-height: 1.6;font-weight: normal;margin: 30px 0 30px;padding: 0;color:#5A6166;text-align:center;">
        Best regards,<br>The Jobify Team</p>
@endsection
